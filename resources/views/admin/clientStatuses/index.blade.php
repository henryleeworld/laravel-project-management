...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-ClientStatus" style="width:100%">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  $('.datatable-ClientStatus:not(.ajaxTable)').DataTable({ buttons: dtButtons })
