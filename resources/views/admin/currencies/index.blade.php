...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-Currency" style="width:100%">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($currencies as $key => $currency)
                        <tr data-entry-id="{{ $currency->id }}">
                            ...
                            <td>
                                {{ $currency->main_currency ? trans('global.yes') : trans('global.no') }}
                            </td>
                            <td>
                                @can('currency_show')
...
@endcan
  ...
  $('.datatable-Currency:not(.ajaxTable)').DataTable({ buttons: dtButtons })
